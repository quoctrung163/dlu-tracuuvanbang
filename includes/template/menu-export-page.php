<?php
echo '<h1 class="myplugin">Xuất thông tin văn bằng ra file Excel</h1>';
?>
<h6 class="myplugin">Vui lòng chọn khoảng thời gian ngày cấp bằng của hồ sơ để xuất ra file:</h6>
